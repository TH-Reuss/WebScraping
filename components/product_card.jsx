...
function ProductCard(props) {
    ...
    useEffect(() => {
      if(props.title.length > props.max_length_title){
        setTitle(splitText(props.title, props.max_length_title))
      }else{
    ...
    return (
      <div className='mb-[6vh] w-[100%]'>
        <h4 className='font-Inter w-[100%] text-[1rem] xl:text-[1.2vw] font-normal text-white text-justify'>{title}</h4>
